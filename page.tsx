...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-red-900/80 via-red-800/70 to-gray-900/80"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-100 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Professional gas services, boiler installations, and heating solutions across Grantham and surrounding
              areas. Your trusted local Gas Safe registered engineers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg shadow-lg">
                <Phone className="mr-2 h-5 w-5" />
                Call Now: 01476 123456
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-blue-900 px-8 py-4 text-lg shadow-lg"
              >
                Get Free Quote
              </Button>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                With over 15 years of experience serving Grantham and the surrounding areas, we're your trusted local
                gas engineers.
              </p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Established in Grantham with a proven track record of reliable, professional service.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">01476 123456</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">info@pestellsgascare.co.uk</div>
                      </div>
                    </div>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mt-12 p-6 bg-blue-50 rounded-lg border-l-4 border-l-blue-600">
                <p className="text-sm text-gray-600">
                  ...
                  info@pestellsgascare.co.uk or 01476 123456.
                </p>
              </div>
            </div>
          </div>
